...
using RucumaGate.Api.Adapters.Injections;
using RucumaGate.Api.Core.Injections;
using RucumaGate.Api.Db.Injections;
using Microsoft.AspNetCore.Mvc.Formatters;
using Microsoft.AspNetCore.Server.Kestrel.Core;
using Newtonsoft.Json.Converters;
using RucumaGate.Api.Web.Filters;
using RucumaGate.Api.Web.Processors;
...
namespace RucumaGate.Api.Web.Server;
